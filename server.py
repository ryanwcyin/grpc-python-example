...
from recommendations.recommendations_pb2 import BookCategory, BookRecommendation, RecommendationResponse

from recommendations.recommendations_pb2_grpc import RecommendationsServicer, add_RecommendationsServicer_to_server
...
class RecommendationService(RecommendationsServicer):
    def Recommend(self, request, context):
        if request.category not in books_by_category:
            # A better way is to raise an exception instead of aboard it
